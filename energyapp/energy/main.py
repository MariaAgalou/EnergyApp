...
def customers_statistics(dataset = dataset):
    ...
    # Get data for last month (i defined February 2014 as the last month)
...
# Data about one single customer
def customer_statistics(id, dataset = dataset):
    ...
    # Graphs
    fig1 = grouped_data.plot(kind='line')
